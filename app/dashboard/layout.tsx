...
const superAdminNavKeys: NavGroupKey[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/admin-return-refunds", labelKey: "nav.manualRefunds", icon: "wallet" },
        ...
        >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 min-w-0">
            ...
            <div className="relative">
              ...
              {notifOpen && (
                <div className="fixed inset-x-3 sm:inset-x-auto sm:end-4 top-16 z-[120] w-auto sm:w-80 max-w-[calc(100vw-24px)] bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="relative" ref={menuRef}>
              ...
              {userMenuOpen && (
                <div className="fixed inset-x-3 sm:inset-x-auto sm:end-4 top-16 z-[120] w-auto sm:w-56 max-w-[calc(100vw-24px)] bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
