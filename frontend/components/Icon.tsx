...
export const ICONS = {
  ...
  snapchat: "M12 3c3.2 0 5.3 2.1 5.3 4.9 0 1.9-.3 3.1-.8 4.5-.1.3.1.5.4.5.4 0 1-.1 1.6-.3.2-.1.4.1.3.3-.2.9-2.1 2-3.6 2.3-.2 0-.3.3-.2.5.1.3.6.8 1.6.8.8-.1 1.3.2 1.3.6 0 .9-1.8 1.3-3.1 1.3-1.3 0-2-.4-2.9-.8-.7-.4-1.4-.3-2.2 0-.8.4-1.6.8-2.9.8-1.3 0-3.1-.4-3.1-1.3 0-.4.5-.7 1.3-.6 1 0 1.5-.5 1.6-.8 0-.2-.1-.5-.2-.5-1.5-.3-3.4-1.4-3.6-2.3 0-.2.1-.4.3-.3.6.2 1.2.3 1.6.3.3 0 .5-.2.4-.5-.5-1.4-.8-2.6-.8-4.5C6.7 5.1 8.8 3 12 3Z",
  tiktok: "M13.5 3h3c.1 0 .2.1.2.3.1 1.6 1.1 2.9 2.6 3.2.2 0 .4.2.3.4v2.7c0 .3-.2.5-.5.5-1.2 0-2.3-.4-3.1-1.1v5.5c0 2.6-2 4.5-4.2 4.5A4.1 4.1 0 0 1 7.5 15c0-2.4 2-4.3 4.6-4.1.3 0 .6.1.9.3V13.5a2 2 0 0 0-1-.3 2.1 2.1 0 0 0 0 4.2c1.1 0 1.5-.8 1.5-2V3Z",
  telegram: "M20.7 4.2 3.7 10.9c-.8.3-1 1.4-.3 1.8l4 2.3.3 4.4c0 .6.8.9 1.4.5l2.5-1.9 3.9 2.8c.5.4 1.3.1 1.5-.6l3.6-14.6c.2-.8-.5-1.5-1.3-1.2ZM8.4 14.6l9.6-6.6c.2-.1.4.1.2.3l-7.9 7.6c-.3.3-.5.7-.6 1.1l-.3 2.1c0 .3-.5.3-.5-.1l-.5-3.2c0-.4.4-.8.4-.8Z",
  linkedin: "M6.5 8H4v12h2.5V8ZM5.5 6.8a1.8 1.8 0 1 0 0-3.6 1.8 1.8 0 0 0 0 3.6ZM20 13.4c0-3-1.6-4.6-3.8-4.6-1.3 0-2 .5-2.5 1.2V8.9H11V20h2.6v-6.1c0-1.2.6-2.1 1.8-2.1s1.6.9 1.6 2.1V20H20v-6.6Z",
  twitter: "M4 4l7.2 9.6L4.4 20H7l5.6-5 4.4 5H20l-7.5-9.9L19.4 4h-2.6l-5.1 4.6L7.6 4H4Z",
  youtube: "M3 8a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V8Zm8 1.5v5l4-2.5-4-2.5Z",
  pinterest: "M12 3a9 9 0 1 0 0 18c-.4-.8-.7-1.6-.9-2.4l1-4.2c.2.4.9 1 1.9 1 2.5 0 4.3-2.3 4.3-5.1 0-2.7-2.2-4.7-4.9-4.7-3.4 0-5.3 2.3-5.3 4.9 0 1 .4 2 1 2.6l-.4 1.6c-.1.2-.3.2-.4 0-1-.5-1.6-2.1-1.6-3.4 0-2.7 2-5.7 5.9-5.7 3.1 0 5.6 2.2 5.6 5.2 0 3.1-2 5.7-4.7 5.7-.9 0-1.8-.5-2.1-1.1l-.6 2.2c-.2.9-.7 2-1.1 2.7A9 9 0 0 0 12 3Z",
