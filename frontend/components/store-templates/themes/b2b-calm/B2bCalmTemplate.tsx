...
export default function B2bCalmTemplate({
  ...
  const { categories, products, productsLoading, selectedCategoryId, setSelectedCategoryId, showAllProducts, setShowAllProducts,
    cartCount, wishlist, toggleWishlist, isSearchActive, searchResults, currencySymbol, isRtl, handleAddToCart, cartMessage, quoteRequested, handleQuoteRequest } = useStorefront(slug, storeId, currency, true, showHero, themeMeta);
