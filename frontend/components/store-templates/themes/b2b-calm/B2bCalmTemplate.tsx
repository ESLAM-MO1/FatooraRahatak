...
import { BagIcon, HeartIcon, HeartFilledIcon, MenuIcon, CloseIcon, MailIcon, PhoneIcon, MapPinIcon, PackageIcon, CheckIcon, LeafIcon } from "@/components/store-templates/icons";
