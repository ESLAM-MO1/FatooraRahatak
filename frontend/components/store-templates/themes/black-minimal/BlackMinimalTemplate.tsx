...
export default function BlackMinimalTemplate({
  ...
  const { categories, products, productsLoading, selectedCategoryId, setSelectedCategoryId, showAllProducts, setShowAllProducts,
    cartCount, wishlist, toggleWishlist, isSearchActive, searchResults, currencySymbol, isRtl, handleAddToCart, cartMessage } = useStorefront(slug, storeId, currency, false, showHero, themeMeta);
