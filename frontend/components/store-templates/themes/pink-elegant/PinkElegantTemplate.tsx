...
import { SearchIcon, BagIcon, HeartIcon, HeartFilledIcon, MenuIcon, CloseIcon, MailIcon, PhoneIcon, MapPinIcon, FacebookIcon, InstagramIcon, WhatsAppIcon, PackageIcon, CheckIcon, TruckIcon } from "@/components/store-templates/icons";
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-3">
              {fbUrl && <a href={fbUrl} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex items-center justify-center rounded-full transition-opacity hover:opacity-70" style={{ width: 34, height: 34, border: "1px solid #E4D3CB", color: colors.accentColor }}><FacebookIcon size={16} /></a>}
              {igUrl && <a href={igUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex items-center justify-center rounded-full transition-opacity hover:opacity-70" style={{ width: 34, height: 34, border: "1px solid #E4D3CB", color: colors.accentColor }}><InstagramIcon size={16} /></a>}
              {waUrl && <a href={waUrl} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="flex items-center justify-center rounded-full transition-opacity hover:opacity-70" style={{ width: 34, height: 34, border: "1px solid #E4D3CB", color: colors.accentColor }}><WhatsAppIcon size={16} /></a>}
            </div>
          </div>
        </div>
