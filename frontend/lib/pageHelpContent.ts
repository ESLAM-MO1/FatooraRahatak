/**
 * محتوى مساعدة كل صفحة في الداشبورد، بيتعرض في المودال اللي بيفتح
 * من أيقونة (؟) الثابتة (PageHelp component).
 *
 * المفتاح = الـ pathname بالظبط زي ما بيظهر من usePathname() (من غير query params).
 * لو الصفحة مش موجودة هنا، زرار المساعدة مش هيظهر ليها خالص.
 *
 * كل صفحة جديدة تتضاف للداشبورد لازم ياخد سطر هنا بنفس الأسلوب: عنوان
 * قصير + شرح تفصيلي (مش مجرد جملة) بيغطي إيه وظيفة الصفحة، وإزاي
 * المستخدم يستخدمها خطوة بخطوة.
 */
...
export const PAGE_HELP_CONTENT: Record<string, PageHelpEntry> = {
  "/dashboard": {
    ...
    bodyAr:
      "هذه هي الصفحة الرئيسية اللي بتشوفها بعد تسجيل الدخول مباشرة.\n\n" +
      "من هنا بتقدر:\n" +
      "• تشوف حالتك الحالية: الباقة المشترك فيها واستهلاكك من المنتجات والموظفين والمخازن.\n" +
      "• تتابع ملخص مبيعاتك خلال الشهر (إجمالي المبيعات، مبيعات نقطة البيع، الفواتير، والطلبات الجديدة).\n" +
      "• تتنقل لبقية أقسام الداشبورد من القائمة الجانبية حسب دورك (صاحب متجر / موظف / مدير عام).\n\n" +
      "المسؤولون العامون وموظفو المنصة يشوفون روابط سريعة لأقسام الإدارة هنا بدل بيانات المتجر.",
    bodyEn:
  ...
  "/dashboard/customers/[id]": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف رقم الهاتف وعدد الطلبات وإجمالي الإنفاق.\n" +
  ...
  "/dashboard/statistics": {
    ...
    bodyAr:
      ...
      "• تشوف إجمالي المبيعات وتوزيع الطلبات حسب الحالة.\n" +
  ...
  "/dashboard/store-settings": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تتحكم في حالة المتجر (نشط / مخفي) وتشوف رابط متجرك وتنسخه.\n" +
  ...
  "/dashboard/subscription": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف باقتك الحالية وتفاصيلها (تاريخ الفوترة، الدورة، تاريخ الانتهاء، الرصيد، وفترة السماح).\n" +
  ...
  "/dashboard/settlements": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف صافي المستحقات المعلقة والمحصلة.\n" +
  ...
  "/dashboard/marketing": {
    ...
    bodyAr:
      ...
      "• تشوف أداء كل قناة (الطلبات، الإيرادات، العملاء، ونسبة المشاركة).\n" +
  ...
  "/dashboard/attendance": {
    ...
    bodyAr:
      "هذه الصفحة تتيح تسجيل حضور وانصراف الموظفين وعرض سجل الحضور.\n\n" +
      "من هنا بتقدر:\n" +
      "• تختار الموظف ثم تضغط تسجيل حضور أو تسجيل انصراف.\n" +
      "• تتصفح سجل الحضور مع فلاتر (موظف محدد أو فترة زمنية).\n\n" +
      "الجدول يعرض: الموظف، التاريخ، وقت الدخول، ووقت الخروج.",
    bodyEn:
      "This page records employee check-in and check-out times and shows the attendance log.\n\n" +
      "From here you can:\n" +
      "• Select an employee, then press Check In or Check Out.\n" +
      "• Browse the attendance log with filters (specific employee or time period).\n\n" +
      "The table shows: employee, date, time in, and time out.",
  },
  ...
  "/dashboard/accounting/journal-entries/[id]": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف بيانات القيد (التاريخ، من أنشأه، من اعتمده، المصدر، والوصف).\n" +
  ...
  "/dashboard/accounting/vouchers/[id]": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف تفاصيل السند (التاريخ، طريقة الدفع، الحساب المقابل، الطرف، الوصف، والمبلغ).\n" +
  ...
  "/dashboard/accounting/invoices/[id]": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف بيانات الطرف وبيانات المتجر (بما فيها الرقم الضريبي عند التسجيل).\n" +
  ...
  "/dashboard/accounting/fixed-assets": {
    ...
    bodyAr:
      ...
      "• تشوف نتيجة التشغيل (قيمة الإهلاك لكل أصل) وتنتقل للقيد المحاسبي المولّد لكل أصل.\n\n" +
  ...
  "/dashboard/accounting/fixed-assets/new": {
    ...
    bodyAr:
      ...
      "• تشوف معاينة فورية للإهلاك الشهري التقديري (التكلفة مقسومة على عدد شهور العمر الإنتاجي).\n\n" +
  ...
  "/dashboard/tickets/[id]": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف بيانات التذكرة (رقم التذكرة، الموضوع، التاريخ، والحالة).\n" +
  ...
  "/dashboard/stores/[id]": {
    ...
    bodyAr:
      ...
      "من هنا بتقدر:\n" +
      "• تشوف البيانات الأساسية للمتجر (الاسم، الرابط، الباقة، الحالة، المالك، عدد المنتجات والموظفين، وتاريخ التسجيل).\n" +
  ...
  "/dashboard/packages": {
    ...
    bodyAr:
      "الصفحة دي مخصصة لفريق منصة فاتورة راحتك (السوبر أدمن / موظف الباقات) لإدارة باقات الاشتراك اللي بتتعرض على التجار.\n\n" +
      "بتقدر من هنا:\n" +
      "• تنشئ باقة جديدة أو تعدّل على باقة موجودة (اسم الباقة، السعر الشهري، ونسبة العمولة على المبيعات لو موجودة).\n" +
      "• تحدد حدود كل باقة (Limits): أقصى عدد منتجات، أقصى عدد طلبات في الشهر، أقصى عدد موظفين، وأقصى عدد مخازن مسموح بيها للتاجر المشترك في الباقة دي. اكتب صفر أو اترك الحقل فاضي لو الميزة دي مش متاحة، أو اختر \"غير محدود\" لو مفيش سقف.\n" +
      "• تفعّل أو تلغي مميزات إضافية للباقة زي: المحاسبة الكاملة، الرواتب، فاتورة إلكترونية (ZATCA)، دومين مخصص، التسويق بالعمولة (Affiliate)، والوصول لـ API.\n" +
      "• تشوف عدد التجار المشتركين حاليًا في كل باقة قبل ما تعدّل أو تحذف باقة، عشان تتجنب التأثير على تجار مشتركين فعلاً.\n\n" +
      "أي تعديل بتعمله هنا بيأثر على التجار الجدد اللي هيشتركوا في الباقة، وممكن يأثر على القديمين حسب سياسة الترقية/التخفيض المطبقة في النظام.",
    bodyEn:
  ...
  "/dashboard/reports": {
    ...
    bodyAr:
      ...
      "• تشوف توزيع المتاجر حسب الباقة مع نسب المشاركة.\n" +
  ...
  "/dashboard/kpis": {
    ...
    bodyAr:
      ...
      "• تشوف رسم بياني لنمو المتاجر الجديدة مقابل الإلغاءات شهريًا.\n" +
  ...
  "/dashboard/admin-verifications": {
    ...
    bodyAr:
      ...
      "• تشوف مستندات كل طلب وتراجع كل مستند على حدة (اعتماد أو رفض مع سبب).\n" +
  ...
  "/dashboard/themes": {
    ...
    bodyAr:
      ...
      "• تشوف معاينة مصغرة لألوان كل تصميم ووصفه وحالته.\n" +
  ...
  "/dashboard/dashboard-sections": {
    ...
    bodyAr:
      ...
      "الدور المستهدف يحدد مين هيشوف القسم (المدير العام / المالك / الموظف)، والصلاحيات تتحكم في ظهور كل رابط على حدة.",
    bodyEn:
