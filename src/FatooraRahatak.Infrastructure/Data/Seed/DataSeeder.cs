...
public static class DataSeeder
{
    ...
    private static async Task SeedSiteMenusAsync(AppDbContext context)
    {
        ...
        var menus = new[]
        {
            new SiteMenu { Location = "features", TitleAr = "النظام المحاسبي المتكامل", TitleEn = "Accounting System", Href = "/accounting-system", SortOrder = 1 },
            ...
            new SiteMenu { Location = "about", TitleAr = "الأكاديمية", TitleEn = "Academy", Href = "/academy", SortOrder = 5 },
            new SiteMenu { Location = "about", TitleAr = "أدوات مجانية", TitleEn = "Free Tools", Href = "/free-tools", SortOrder = 6 },

            new SiteMenu { Location = "footer-tools", TitleAr = "النظام المحاسبي المتكامل", TitleEn = "Accounting System", Href = "/accounting-system", SortOrder = 1 },
            ...
            new SiteMenu { Location = "footer-about", TitleAr = "الأكاديمية", TitleEn = "Academy", Href = "/academy", SortOrder = 9 },
