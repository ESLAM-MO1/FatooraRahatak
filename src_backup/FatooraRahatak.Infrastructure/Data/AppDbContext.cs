...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // User → Store (One Owner has One Store)
        modelBuilder.Entity<Store>()
            .HasOne(s => s.Owner)
        ...
        // User → Employee (One User has One Employee Profile)
        ...
        modelBuilder.Entity<RefreshToken>()
            ...
            .IsUnique();
        // Category - Self Referencing (تصنيفات فرعية)
...
// Unique Index: كل منتج/متغير له سطر واحد بس في كل مستودع
modelBuilder.Entity<InventoryStock>()
